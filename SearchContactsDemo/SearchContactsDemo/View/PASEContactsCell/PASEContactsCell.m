...
@interface PASEContactsCell()
@property (nonatomic,strong) UIImageView * icon;
@end

@implementation PASEContactsCell
...
//    NSLog(@"%s",__func__);
    ...
    UIAlertAction * actionTrue = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        NSMutableString  *str = [[NSMutableString alloc] initWithFormat:@"tel:%@",weakSelf.model.mobile];
...
/**
 ...
 @param model 常用联系人模型
 */
- (void)setModel:(PASEContactsModel *)model{
    _model = model;
